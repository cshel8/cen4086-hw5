...
const server = new McpServer(
  { name: 'meeple-harbor-support', version: '1.0.0' },
...
server.registerResource(
  ...
  'business://policies',
  {
    title: 'Meeple Harbor policy documents',
    description: 'Read-only policy documents for Meeple Harbor, a café offering board games and card games, covering store hours, returns, warranties, game library rules, and event reservations.',
  ...
  ({ customerMessage }) => ({
    messages: [{
      ...
      content: {
        type: 'text',
        text: [
          'Resolve this support request for Meeple Harbor:',
          customerMessage,
          '',
          'Workflow:',
